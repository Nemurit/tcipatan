(function () {
    ...
    function displayTable(summary) {
        ...
        Object.entries(summary).forEach(([buffer, count]) => {
            const row = $('<tr></tr>');
            row.append(`<td>${buffer}</td>`);
    ...
    function addToggleButton() {
        const toggleButton = $('<button id="toggleButton" style="position: fixed; top: 10px; left: 10px; padding: 4px; background-color: #007bff; color: white; border: none; border-radius: 5px; cursor: pointer;">Mostra Recuperi</button>');
        ...
        const chartButton = $('<button id="chartButton" style="position: fixed; top: 50px; left: 10px; padding: 4px; background-color: #28a745; color: white; border: none; border-radius: 5px; cursor: pointer;">Visualizza Grafico</button>');
    ...
    function updateChart(summary) {
        ...
        if (!chart) {
            ...
            const chartContainer = $('<div id="chartContainer" style="position: fixed; top: 100px; left: 10px; width: 400px; height: 400px; background: white; padding: 10px; border: 1px solid #ddd; display: none;"></div>');
