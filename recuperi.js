(function() {
    ...
    function addToggleButton() {
        const button = $('<button id="toggleButton" style="position: fixed; top: 950px; left: 10px; z-index: 10001; padding: 10px; background-color: rgba(255, 255, 255, 0.9); border-radius: 5px; display: flex; flex-direction: row;"><button style="padding: 3px; background-color: rgb(76, 175, 80); color: white; border: none; border-radius: 3px; margin-right: 5px;">Mostra Recuperi</button>');
