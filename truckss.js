(function () {
    ...
    function filterAndShowData(hours) {
        ...
        const laneFilter = laneInputBox.value.trim().toLowerCase();
    ...
    function showButtonsAndInputs() {
        ...
        laneInputBox.style.display = 'inline-block';
    ...
    function createButtons() {
        ...
        laneInputBox.style.display = 'none';
        ...
        rowCountDisplay.style.marginRight = '10px';
        ...
        containermain.appendChild(laneInputBox);
    ...
    // Inizializza la configurazione della pagina
    createButtons();
})();
