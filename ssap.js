...
(function() {
    ...
    newButton.addEventListener('click', function() {
        ...
        if (results.length === 0) {
            ...
            let message = 'Schema di carico per camion con due destinazioni:\n';
            results.forEach(({ truckId, destinations, containers }) => {
                message += `Camion ${truckId} (${destinations}): ${containers.join(', ')}\n`;
            });
            alert(message);
        }
    });
